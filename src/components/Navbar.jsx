    ...
    <div className="relative">
      <div className="navbar bg-gradient-to-r from-white/30 via-white/10 to-transparent text-black p-4 shadow-md backdrop-blur-md">
        ...
        <div className="navbar-end space-x-2 hidden lg:flex">
          ...
          <Link to="/signin" className="btn btn-outline  text-white border- hover:bg-white hover:text-blue-500">
            Sign In
          </Link>
        ...
        <div className="navbar-end lg:hidden">
          <div className="dropdown dropdown-end">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-indigo-700 rounded-box w-52"
            >
              <li>
